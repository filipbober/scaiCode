...
void StrategyManager::addStrategies()
{
	...
	terranOpeningBook[Terran3FactoryVultureRush] = "0 0 0 0 0 17 0 0 19 0 18 0 0 0 17 1 0 0 22 1 0 22 1 0 23 17 0 3 0 0 47 0 0 3 23 0 17 0 22 38";		// <- Preferred build order
