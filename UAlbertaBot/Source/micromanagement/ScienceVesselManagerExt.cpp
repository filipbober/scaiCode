...
ScienceVesselManagerExt::ScienceVesselManagerExt() : unitClosestToEnemy(NULL) {}
...
BWAPI::Unit * ScienceVesselManagerExt::closestCloakedUnit(const UnitVector & cloakedUnits, BWAPI::Unit * detectorUnit)
{
